...
#
# $foo_backup_data (true|false) :
#     Set if you want to backup foo's data. Default: As defined in $backup_data
#
# $foo_backup_log (true|false) :
#     Set if you want to backup foo's logs. Default: As defined in $backup_log
#
# $foo_backup_frequency (hourly|daily|weekly|monthly) :
#     Set the frequency of your foo backups. Default: daily.
#
# $foo_backup_target :
#     Define how to reach (Ip, fqdn...) this host to backup foo from an external server.
