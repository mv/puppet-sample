...
#
# $ntp_backup_data (true|false) :
#     Set if you want to backup ntp's data. Default: As defined in $backup_data
#
# $ntp_backup_log (true|false) :
#     Set if you want to backup ntp's logs. Default: As defined in $backup_log
#
# $ntp_backup_frequency (hourly|daily|weekly|monthly) :
#     Set the frequency of your ntp backups. Default: daily.
#
# $ntp_backup_target :
#     Define how to reach (Ip, fqdn...) this host to backup ntp from an external server.
...
class ntp::backup {
    ...
    if $my_project { include "ntp::${my_project}::backup" }
