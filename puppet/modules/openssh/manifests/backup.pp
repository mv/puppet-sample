...
#
# $openssh_backup_data (true|false) :
#     Set if you want to backup openssh's data. Default: As defined in $backup_data
#
# $openssh_backup_log (true|false) :
#     Set if you want to backup openssh's logs. Default: As defined in $backup_log
#
# $openssh_backup_frequency (hourly|daily|weekly|monthly) :
#     Set the frequency of your openssh backups. Default: daily.
#
# $openssh_backup_target :
#     Define how to reach (Ip, fqdn...) this host to backup openssh from an external server.
