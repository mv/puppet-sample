...
#
# $puppet_backup_data (true|false) :
#     Set if you want to backup puppet's data. Default: As defined in $backup_data
#
# $puppet_backup_log (true|false) :
#     Set if you want to backup puppet's logs. Default: As defined in $backup_log
#
# $puppet_backup_frequency (hourly|daily|weekly|monthly) :
#     Set the frequency of your puppet backups. Default: daily.
#
# $puppet_backup_target :
#     Define how to reach (Ip, fqdn...) this host to backup puppet from an external server.
...
class puppet::backup {
    ...
    if $my_project { include "puppet::${my_project}::backup" }
